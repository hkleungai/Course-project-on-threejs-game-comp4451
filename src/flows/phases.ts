...
const getNeighbors = (map: GameMap, tile: Tile, exclude_inaccessible: boolean = true): Tile[] => {
...
const getNeighborsAtRange = (gameMap: GameMap, tile: Tile, range: number, exclude_inaccessible: boolean = true) : Tile[] => {
	if (!isInteger(range)) {
